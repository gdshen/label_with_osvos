            ...
            Canvas {
                ...
                onPaint: {
                    ...
                    if (fillTheRegion) {
                        ctx.fillStyle = '#fff'
                        ctx.beginPath()
                        ctx.moveTo(points[0].startPoint.X,
                                   points[0].startPoint.Y)
                    ...
                    for (var i = 0; i < points.length; i++) {
                        ...
                        if (drawAdditionalInformation) {
                            ...
                            ctx.lineTo(point.controlPoint.X,
                                       point.controlPoint.Y)
                            ctx.stroke()
                            ...
                            ctx.beginPath()
                            ctx.strokeStyle = canvas.rectColor
                            ctx.rect(point.controlPoint.X,
                                     point.controlPoint.Y, rectWidth, rectWidth)
                            ctx.stroke()
                        }
                    }
                }
                    ...
                    onPressed: {
                        ...
                        if (canvas.altPressed) {
                            ...
                            if (canvas.controlPressed) {
                                ...
                                var point = canvas.findClosedPoint(currentPoint)
                                var distance = canvas.computeDistance(
                                            currentPoint, point)
                                console.log("Distance is " + distance)
                                if (distance < canvas.distanceThrehold) {
                                    canvas.points.push({
